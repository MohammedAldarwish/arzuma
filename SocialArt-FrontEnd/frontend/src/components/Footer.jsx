      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">ArtConnect</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              A vibrant community where artists share their creativity, connect with fellow creators, and discover amazing artwork from around the world.
            </p>
